import sys, math
input = [line for line in open("day10/input.txt").readlines()]

#use python3 instead of python (2) because of math import (math.gcd)
...
asteroid_coordinates = [(x, y) for y, row in enumerate(input) for x, value in enumerate(row) if value == '#']
...
print("Part 2: "+str(vaporization_order[200][0] * 100 + vaporization_order[200][1]))